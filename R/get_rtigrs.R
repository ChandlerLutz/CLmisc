...
#'
#' @param tigris_fun A function from the \code{\link[tigris:tigris-package]{tigris}} package.  This should be passed as a bare function name (e.g., \code{zctas}, not \code{"zctas"}).
#' @param save_dir The directory where the cached RDS files should be saved. Defaults to \code{here::here("data-raw/tigris/")}.
#' @param ... Additional arguments to be passed to the \code{tigris_fun}.  These arguments will be incorporated into the name of the cached file, allowing for different cached versions based on different function arguments.
#'
#' @return An sf object containing the data retrieved from the specified \code{tigris_fun}.
#'
#' @details
